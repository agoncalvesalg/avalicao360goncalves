...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "avalicao360goncalves@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "avalicao360goncalves API";

        private String description = "avalicao360goncalves API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "avalicao360goncalves";
